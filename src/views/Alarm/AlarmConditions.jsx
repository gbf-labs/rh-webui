...
class AlarmConditions extends React.Component {
  ...
  getAlarmConditions = () => {
    const requestURL = general.getAPIUrl() + "/alarm/condition/index";
  ...
  getAlarmParameters = () => {
    const requestURL = general.getAPIUrl() + "/alarm/parameters/index";
    this.toggleLoading(true);
    request(requestURL, {
      method: "GET"
    })
  ...
  getAlarmOperators = () => {
    const requestURL = general.getAPIUrl() + "/alarm/operators/index";
    this.toggleLoading(true);
    request(requestURL, {
      method: "GET"
    })
  ...
  deleteAlarmCondition = () => {
    const requestURL = general.getAPIUrl() + "/alarm/condition/delete";
    const params = {
  ...
  createAlarmCondition = () => {
    const requestURL =
      general.getAPIUrl() + "/alarm/condition/" + this.state.dialogType;
    const paramErrs = [];
