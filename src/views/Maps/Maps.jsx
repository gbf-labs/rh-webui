...
class MapComponent extends React.Component {
  ...
  getVessels = () => {
    const requestURL = general.getAPIUrl() + "/vessels/data";
    ...
    request(requestURL, { method: "GET" })
      .then(response => {
        ...
        const comp = Object.entries(response.companies);
        const companies = comp.map(elm => ({
          label: elm[0],
          value: elm[0]
        }));
        companies.unshift({
        ...
        this.props.updateCompanyList(companies);
      })
      .catch(() => {
...
MapComponent.propTypes = {
  ...
  updateCompanyList: PropTypes.func.isRequired,
