...
class Device extends React.Component {
  ...
  getDeviceList = () => {
    const requestURL = general.getAPIUrl() + "/device/list";
    let dt = "";
    ...
    request(requestURL, {
      ...
      .then(response => {
        ...
        this.setState({
          ...
          devImage: img,
          dataUrl: response.data[0].data_url
        });
      })
      .catch(() => {
        this.toggleLoading0(false);
  ...
  getDeviceInfo = () => {
    ...
    const requestURL = general.getAPIUrl() + "/device/state";
    const vessId = this.props.match.params.vessel_id;
  ...
  postRemoteCommands(key, others, label) {
    const requestURL = general.getAPIUrl() + "/remote/command";
    const params = {
      key,
      others,
      label,
  ...
  getAlarmState = () => {
    const vessel_id = this.props.match.params.vessel_id;
    const device_id = this.props.match.params.device_id;
    const requestURL = general.getAPIUrl() + "/alarm/state/index";
    request(requestURL, {
      method: "GET",
      params: {
        verbose_level: 50,
