...
class RBACUsers extends React.Component {
  ...
  getCompany = () => {
    const requestURL = general.getAPIUrl() + "/company/index";
    request(requestURL, {
      method: "GET",
      params: {
        limit: 100,
  ...
  getUserCompany = userid => {
    const requestURL = general.getAPIUrl() + "/user/company";
    request(requestURL, {
      method: "GET",
      params: {
        account_id: userid
  ...
  getRole = () => {
    const requestURL = general.getAPIUrl() + "/role/index";
    request(requestURL, {
      method: "GET",
      params: {
        limit: 100,
  ...
  getUsers = () => {
    const requestURL = general.getAPIUrl() + "/user/index";
  ...
  sendInvite = () => {
    ...
    const requestURL =
      general.getAPIUrl() + "/user/" + this.state.dialogType;
    let vssls = [];
  ...
  disableUser = () => {
    const requestURL = general.getAPIUrl() + "/user/disable";
    const params = {
  ...
  deleteUser = () => {
    const requestURL = general.getAPIUrl() + "/user/delete";
    const params = {
      user_ids: this.state.selectedUserId
    };
  ...
  enableUser = () => {
    const requestURL = general.getAPIUrl() + "/user/enable";
    const params = {
      user_ids: this.state.selectedUserId
    };
    request(requestURL, { method: "PUT", body: params }, true)
  ...
  reInvite = () => {
    const { classes } = this.props;
    const requestURL = general.getAPIUrl() + "/user/reinvite";
    const params = {
      user_ids: this.state.selectedUserId
    };
