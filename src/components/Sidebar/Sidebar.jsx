...
class Sidebar extends React.Component {
  state = {
    ...
    openAlarm: false,
    vesselStatesOptions: [
      { value: "all", label: "All Vessels", color: "#666666" },
  ...
  generateVesselList = () => {
    ...
    return vessels.map(vessel => (
      <Tooltip key={`item-${vessel.vessel_id}`} title={vessel.vessel_name}>
        <ListItem
          button
          className={classes.vesselListItemPadding}
          // onClick={()=>this.toggleVesselInfo(vessel)}
        >
          {vessel.vessel_name && (
            <ListItemAvatar className={classes.vesselIconSize}>
              <FiberManualRecordIcon
                className={classes[vessel.update_state + "State"]}
              />
              {/* <FiberManualRecordIcon /> */}
          ...
          >
            <ListItemText
              primary={general.truncateText(vessel.vessel_name, 15)}
              secondary={null}
            />
            <ListItemSecondaryAction
              className={classes.vesselListItemSecondaryPadding}
            >
              <IconButton>
                <NavigateNext />
              </IconButton>
              ...
              <List component="div" disablePadding>
                <ListItem button>
                  <Select
                    ...
                    defaultValue={{ value: "All", label: "All Vessels" }}
                    styles={colourStyles}
                    name="Vessel Status"
                ...
                <ListItem button>
                  <Select
                    ...
                    defaultValue={{ value: "All", label: "All Company" }}
                    name="Company Names"
                    options={this.props.companyList}
                    onChange={this.props.sidebarFilterCompany}
                    menuPosition="fixed"
                  />
                </ListItem>
...
Sidebar.propTypes = {
  ...
  sidebarFilterCompany: PropTypes.func.isRequired,
