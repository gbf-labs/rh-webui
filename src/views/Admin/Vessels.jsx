...
class Vessels extends React.Component {
  ...
  getVesselReport = () => {
    const requestURL = general.getAPIUrl() + "/vessels/report";
  ...
  getVessels = () => {
    const requestURL = general.getAPIUrl() + "/vessels";
    this.toggleLoading(true);
  ...
  updateVessel = () => {
    const requestURL = general.getAPIUrl() + "/email/schedule/update";
    let timeFltr = [];
    for (
      let i = 0;
  ...
  updateNoonReport = () => {
    const requestURL = general.getAPIUrl() + "/vessels/report/update";
    const params = {
      vessel_ids: this.state.selectedVessId,
  ...
  updateVesselState = (vessId, vessSt) => {
    const requestURL = general.getAPIUrl() + "/vessels/state/update";
    const params = {
      vessel_id: vessId,
      state: vessSt
    };
  ...
  vesselImgUploadHandler = () => {
    ...
    if (this.state.uploadData.vesselProfileImg) {
      ...
      const requestURL = general.getAPIUrl() + "/vessels/image";
  ...
  vesselFilesUploadHandler = () => {
    ...
    if (this.state.uploadData.vesselFiles) {
      ...
      const requestURL = general.getAPIUrl() + "/vessels/file";
  ...
  deleteVesselProf = vessId => {
    const requestURL = general.getAPIUrl() + "/vessels/image/delete";
    const params = {
      vessel_ids: [vessId]
    };
    let reqType = "DELETE";
  ...
  deleteVesselFiles = fileName => {
    const requestURL = general.getAPIUrl() + "/vessels/file/delete";
    const params = {
  ...
  getVesselFiles = () => {
    ...
    const requestURL = general.getAPIUrl() + "/vessels/file/list";
    let reqType = "GET";
  ...
  deleteVessel = () => {
    const requestURL = general.getAPIUrl() + "/vessels/delete";
    const vessInfo = [];
  ...
  createVessel = () => {
    const requestURL = general.getAPIUrl() + "/vessels/create";
    const params = {
  ...
  getINIFiles = vessId => {
    const requestURL = general.getAPIUrl() + "/ini/files";
  ...
  updateINIFiles = () => {
    const requestURL = general.getAPIUrl() + "/update/ini/files";
