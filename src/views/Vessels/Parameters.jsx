...
class Parameters extends React.Component {
  ...
  getParameters() {
    const requestURL = general.getAPIUrl() + "/vessels/parameters";
  ...
  isPasswordAllowed = () => {
    if (
      ...
      general.checkPermission("vessel_parameters_show password")
    ) {
      return true;
    }
    return false;
              ...
              <Paper className={classes.root}>
                <Table className={classes.tableLayout}>
                  ...
                  <TableBody>
                    ...
                    {!this.state.loading &&
                      this.state.parametersData.map(row => (
                    ...
                    {!this.state.loading &&
                      this.state.parametersData.length === 0 && (
                        <TableRow>
...
export default withStyles(styles)(withSnackbar(Parameters));
