...
class SubCategory extends React.Component {
  ...
  getSubCategory = () => {
    const requestURL = general.getAPIUrl() + "/subcategory";
  ...
  deleteSubCategory = () => {
    const requestURL = general.getAPIUrl() + "/subcategory/delete";
    const params = {
  ...
  createSubCategory = () => {
    const requestURL = general.getAPIUrl() + "/subcategory/" + this.state.dialogType;
    const params = {
