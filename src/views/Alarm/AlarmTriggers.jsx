...
class AlarmTriggers extends React.Component {
  ...
  getAlarmTriggers = () => {
    const requestURL = general.getAPIUrl() + "/alarm/trigger/index";
  ...
  getAlarmTypes = () => {
    const requestURL = general.getAPIUrl() + "/alarm/type/index";
    this.toggleLoading(true);
    request(requestURL, {
      method: "GET"
    })
  ...
  deleteAlarmTrggr = () => {
    const requestURL = general.getAPIUrl() + "/alarm/trigger/delete";
    const params = {
  ...
  createAlarmTrigger = () => {
    const requestURL =
      general.getAPIUrl() + "/alarm/trigger/" + this.state.dialogType;
    const params = {
