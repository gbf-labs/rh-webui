...
class AlarmValues extends React.Component {
  ...
  getAlarmValueData = () => {
    const requestURL = general.getAPIUrl() + "/alarm/value/data";
  ...
  getAlarmValues = () => {
    const requestURL = general.getAPIUrl() + "/alarm/value/index";
    this.toggleLoading(true);
    request(requestURL, {
      method: "GET",
      params: {
  ...
  deleteAlarmValue = () => {
    const requestURL = general.getAPIUrl() + "/alarm/value/delete";
    const params = {
  ...
  createAlarmValues = () => {
    const requestURL =
      general.getAPIUrl() + "/alarm/value/" + this.state.dialogType;
    const params = {
